...
const mockFetch = createMockFetch([
  ...
  { match: 'binance.com', response: url => ({ price: priceFromUrl(url) * 0.98 }) },
  ...
  { match: 'etherscan.io', response: { result: { ProposeGasPrice: '30', SafeGasPrice: '30', FastGasPrice: '40' } } },
  { match: 'bscscan.com', response: { result: { ProposeGasPrice: '8', SafeGasPrice: '8', FastGasPrice: '9' } } },
  { match: 'polygonscan.com', response: { result: { ProposeGasPrice: '35', SafeGasPrice: '35', FastGasPrice: '40' } } },
  { match: 'snowtrace.io', response: { result: { ProposeGasPrice: '20', SafeGasPrice: '20', FastGasPrice: '25' } } },
  { match: 'beaconcha.in', response: { data: { standard: 30000000000 } } },
  ...
  { match: 'rollup_gasPrices', response: { result: { l1GasPrice: '0x59682f00', l2GasPrice: '0x59682f00', l1DataFee: '0x1312d0' } } },
